...
Inputs enter the economic system as irreversible inflows.

Energy, time, and materials arrive once. They may be converted, stored imperfectly, or dissipated, but they cannot be cyclically reintroduced without further cost. There is no perpetual motion in economics.
...
Allocation decisions are time-bound and irreversible.

Once an input is allocated, alternative possibilities collapse. Reversing an allocation requires additional inputs and introduces loss. Economic history advances forward only.

### Axiom 5 — Physical Accounting

Valid economic claims must be consistent with physical constraints.
